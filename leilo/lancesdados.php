...
<body>
    ...
    <div class="jumbotron">
        <div class="container">
            <h1 class="display-4">Lances dos Leilões</h1>
            <p class="lead">Registro dos Lances visível apenas para ADM</p>
        </div>
    </div>
        ...
        <div class="row">
            ...
            if ($num_rows > 0) {
                while ($dado = mysqli_fetch_assoc($res)) {
                    ...
                    echo "<img src='uploads/" . $dado['Link'] . "' alt='" . $dado['NomeProduto'] . "'>"; // Corrigido o caminho da imagem
                    echo "<p>Valor Inicial: R$ " . $dado['Valor'] . "</p>";
                    echo "<a class='btn btn-danger' href='excluilance.php?cod=" . $dado['idDesapego'] . "'>Excluir</a>";
                    echo "</div>";
                    echo "</div>";
                }
            }
