...
<body>
  ...
  <div class="jumbotron">
    <div class="container">
      ...
      <p class="lead">Registro dos Lances VISIVEL APENAS PARA ADM</p>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      ...
      $sql = "SELECT * FROM lance ORDER BY idLance DESC";
      ...
      if ($num_rows > 0) {
        while ($dado = mysqli_fetch_assoc($res)) {
          ...
          echo "<h3>" . $dado['idLance'] . "</h3>";
          echo "<p>Lance ou Serviço: " . $dado['ValorLance'] . "</p>";
          echo "<a class='btn btn-danger' href='excluilance.php?cod=".$dado['idLance']."' >Excluir</a>";
          echo "</div>";
          echo "</div>";
        }
      }
